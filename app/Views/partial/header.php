            ...
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand hidden-sm" href="<?= site_url() ?>">
                        <span class="dotco-brand">
                            <span class="dotco-wordmark" aria-label="DOT.CO">
                                <span>DOT</span><span class="dotco-dot" aria-hidden="true"></span><span>CO</span>
                            </span>
                        </span>
                    </a>
                </div>
