...
return [
    ...
    "csv_import_partially_failed"    => "{0} sale import failure(s) on line(s): {1}",
    "csv_import_success"              => "Sales imported successfully",
    "csv_import_nodata_wrongformat"   => "No data or wrong format",
    "invoice"                          => "Invoice",
