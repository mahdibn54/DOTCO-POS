...
class Item extends Model
{
    ...
    public function get_card_items(?string $search, ?string $category, int $limit, int $offset): array
    {
        $builder = $this->db->table('items');
        $builder->select('item_id, item_number, name, unit_price, pic_filename, category');
        $builder->where('deleted', 0);
    ...
    public function get_card_items_count(?string $search, ?string $category): int
    {
        $builder = $this->db->table('items');
    ...
    public function get_card_categories(?string $search): array
    {
        $builder = $this->db->table('items');
